...
import { Button, Card, FilterBar, Msg, SelectField } from "@op/site-ui";
import { api, errText, HISTORY_KIND_LABEL, type HistoryResponse } from "../../api";
import { AccountHead, Actions } from "../../lib/shell";
  ...
  return (
    <>
      <AccountHead
        ...
        sub="Nạp, quy đổi vật phẩm, hoàn Xu khi game từ chối, điều chỉnh do hỗ trợ."
      />
