import { Card, Empty, LinkButton, Msg, Section, formatDate, timeAgo } from "@op/site-ui";
...
export function Overview() {
  ...
  return (
    <>
      ...
      <Section
        title="Game của bạn"
        sub="Tài khoản game được tạo tự động lần đầu bạn bấm Chơi ngay."
      ...
      <Section
        title="Đơn gần đây"
        sub="Năm lần mua gói gần nhất ở tất cả các game."
