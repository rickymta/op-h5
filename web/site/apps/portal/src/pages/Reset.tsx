...
import { Button, Field, LinkButton, Msg } from "@op/site-ui";
  ...
  if (!token) {
    return (
      <AuthShell title="Đặt lại mật khẩu" foot={<a href="/dang-nhap">← Về đăng nhập</a>}>
        ...
        <LinkButton href="/quen-mat-khau" variant="ghost" full>
    ...
    >
      {reset.isSuccess ? (
        <>
          ...
          <LinkButton href="/dang-nhap" full size="lg">
            Đăng nhập
          </LinkButton>
        </>
      ) : (
        ...
        >
          ...
          <Button type="submit" full size="lg" className="mt-1.5" disabled={reset.isPending || !ok}>
