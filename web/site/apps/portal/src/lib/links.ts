 ...
 *
 * `/cho` nằm ở đây vì chợ là một bundle riêng (`site/apps/market`) do cùng tiến trình `id`
 * phục vụ dưới tiền tố đó. Bắt lấy nó bằng wouter thì người dùng rơi vào trang 404 của cổng
 * chứ không sang được chợ.
 */
const SERVER_PATHS = ["/api/", "/oauth/", "/cho", "/internal/", "/.well-known/", "/healthz"];
