...
import { Button, Card, LinkButton, Msg, Section, StatCard, formatDate, formatInt } from "@op/ui/publisher";
...
export function Wallet() {
  ...
  return (
    <>
      ...
      {/* Bốn ô thống kê: `pb-stats--2` để ở điện thoại xếp 2×2 thay vì một hàng bốn ô bóp nhỏ. */}
