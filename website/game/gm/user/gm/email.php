...
<!--                            填写gm码-->
                            <div class="form-group">
                                <div class="col-sm-10">
                                <h4>getfilter</h4>
                                    <input type="password" id="checknum" name="checknum" class="form-control" maxlength="16" value="" placeholder="Nhập mã GM: pgaming" required>
                                </div>
                            </div>
<!--                            获取区的列表-->
                            <div class="form-group">
...
<!--                            填入的是账号-->
                            <div class="form-group">
                                <div class="col-sm-10">
                                    <input type="text" id="uid" name="uid" class="form-control" value="" placeholder="Nhập tên tài khoản" required>
                                </div>
                            </div>
...
<!--                            点击发送按钮-->
                            <div class="form-group">
                                <div class="col-sm-10 ">
                                <button type="submit" class="btn btn-primary btn-block" onclick="send_mail()">Bưu kiện gửi đi</button>
                                </div>
                            </div>
