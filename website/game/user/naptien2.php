<div class="content-wrapper luna-new-year" id="f-content">
    <h1 style="font-size:0">Võ Lâm Ngũ Bá</h1>
                            ...
                            <div class="method-detail">
                                ...
                                <div class="method-meta">
                                    ...
                                    <div class="method-gift">
                                        <i class="fa fa-gift" aria-hidden="true"></i>Khuyến mãi lên tới 250%
                                    </div>
                                </div>
                            </div>
                        </label>
    ...
    <div class="form-group">
        ...
        <div class="alert alert-danger">
										...
										Bạn nạp trên 1m, hãy inbox admin Fanpage hoặc Zalo để nhận quà thêm nhé
										</div>
    </div>
        ...
        <ul class="nav nav-tabs" role="tablist" id="tab-header">
            <li role="presentation" class="nav-item">
                <a href="#" class="nav-link active" aria-controls="momo_mob">
                    <img src="" class="img-responsive"> <span>ACB Á Châu</span>
                </a>
            </li>
        </ul>
            ...
            <div id="momo_mob" class="panel tab-pane active">
                <div>
                    <p style="font-weight: bold;">
                        Khi thực hiện việc chuyển tiền qua gói dịch vụ ATM/iBanking của Võ Lâm Ngũ Bá:</br>
						<strong style="color:red">[Phần Nội Dung]</strong> bạn nhớ ghi đúng <strong style="color:red">[vl5b <?=$info['username']?>]</strong> để nhận được Xu.
                    </p>
                </div>
                <ul>
                    <li>Tài khoản: <strong>13769081</strong></li>
                    <li>Ngân hàng: <strong>ACB - Á Châu</strong></li>
                    <li>chủ tài khoản: <strong>Đặng Thị Sen</strong></li>
    ...
    <div class="form-group">
        <label>Nội dung chuyển khoản</label>
        <div class="input-elm input-code-wrapper">
            <input type="text" class="input-code" disabled="" value="vl5b <?=$info['username']?>">
        </div>
    </div>
    <p>Quý khách vui lòng chuyển khoản theo nội dung dưới đây:</p>
    <div class="popup-transfer">
        ...
        <div class="tab-content">
            <div id="momo_mob" class="panel tab-pane active">
                <div>
                    <p style="font-weight: bold;">
                        Khi thực hiện việc chuyển tiền qua gói dịch vụ MoMo của Võ Lâm Ngũ Bá:</br>
						<strong style="color:red">[Phần Nội Dung]</strong> bạn nhớ ghi đúng <strong style="color:red">[vl5b <?=$info['username']?>]</strong> để nhận được Xu.</br>
