...
if ($info) {
    // Nếu có, đặt giá trị vào $_SESSION['username']
    $_SESSION['username'] = $username;
    // Thực hiện các hành động khác nếu cần thiết sau khi đăng nhập thành công
...
<head>
	...
	<meta itemprop="name" content="Đại Hải Trình Mobile - Game Võ hiệp Thế Hệ Mới">
	<meta itemprop="description" content="Đại Hải Trình Mobile - Game Võ hiệp Thế Hệ Mới">
	<!--<meta itemprop="image" content="https://imgur.com/blcTh3q.png">-->
	
	<!-- Facebook Meta Tags -->
	<meta property="og:url" content="http://192.168.1.69">
	<meta property="og:type" content="website">
	<meta property="og:title" content="Đại Hải Trình Mobile - Game Võ hiệp Thế Hệ Mới">
	<meta property="og:description" content="Đại Hải Trình Mobile - Game Võ hiệp Thế Hệ Mới">
    ...
    <div id="__next">
        <div id="app" class="">
            ...
            <div class="footer">
                ...
                <div class="bq">Một sản phẩm của Đại Hải Trình Mobile</div>
            </div>
            ...
            <div class="box-cnhd" id="fixed-menu">
                <div class="fixCen main-menu luna-new-year">
                 <!--   <a role="presentation" class="btn-cnm btnbt-6 " href="/user"><span class="fun-ic ic-homepage"></span>Trang Chủ</a>
					...
					<a role="presentation" class="btn-cnm btnbt-4 " href="/doi-knb"><span class="fun-ic ic-knb"></span>Đổi KNB</a>
