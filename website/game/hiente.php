<html>
<head>
    <title>New World AFK - Game One Piece AFK Thế Hệ Mới</title>
    <meta charset='utf-8' />
...
$('.dragitem').click(function() {
	...
	$('#iframe').html("<iframe class='none' style='z-index: 999999; position: absolute;width: 100%; height: 100%;border: 0;' src='http://newworld.mobi/nap-tien'></iframe>");
});
});
function openNapTien(){
    ...
    <script type="text/javascript" src="a3b31-4c087-1dc2f-hiente.js"></script>
</body>
</html>