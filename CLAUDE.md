...
- **Tự đánh ải tiếp** (`op-tu-danh.js`, 2026-09-07): bundle chỉ thêm một dòng gọi `window.opKetQuaTran` ở `afterOpen()` của màn thắng trận; shim bấm đúng nút "Khiêu chiến tầng tiếp" (đi qua kiểm tra thể lực/lượt của game) khi người chơi bật nút DOM "Tự đánh" — nhận Excel/bundle mới thì chạy lại `va-tu-danh-ai.py`.
